...
export const letterhead: MockupTemplate = {
  ...
  render(ctx) {
    ...
    const page = `<rect width="${PW}" height="${PH}" fill="${surface.background}" filter="url(#soft)"/>
      ...
      ${text(PW - pad, 100, content.website, { size: 15, fill: surface.primary, font: "bb", anchor: "end" })}
      ...
      ${text(PW - pad, PH - 42, content.website, { size: 15, fill: surface.primary, font: "bb", anchor: "end" })}`;
