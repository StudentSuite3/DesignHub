...
const features = [
  ...
  { icon: ShieldCheck, title: "No backend", body: "Nothing you make leaves your browser. There is no server to leak it." },
  { icon: WifiOff, title: "Offline first", body: "Color, type scale and export tools work without a connection." },
  { icon: Keyboard, title: "Keyboard first", body: "⌘K for everything, G-shortcuts to jump, space to shuffle palettes." },
    ...
    <section aria-labelledby="features-title" className="border-y bg-surface">
      <div className="mx-auto flex max-w-6xl flex-col gap-12 px-4 py-16 md:py-24">
        <div className="flex max-w-2xl flex-col gap-2">
          ...
          <p className="text-muted-foreground">Fast, quiet and respectful of your data — inspired by Linear, Raycast and Vercel.</p>
        </div>
